...
[dfuel, Fueldt, a, q, M, Fd, Thrust, flapdeflection, Alpha, rho,lift,Penalty,zeta,phi,eq] = VehicleModel(time, theta, V, v, mfuel, nodes,scattered,gridded,const,thetadot, Atmosphere, SPARTAN_SCALE);
...
RunningCost =((q-50000).^2+50000)/50000 + [0.005*abs(omegadot)]; % tighter
...
RunningCost =((q-50000).^2+1000000)/1000000 + [0.005*abs(omegadot)]; % tighter
...
%   RunningCost =Penalty + 0.01*abs(omegadot); %including omegadot makes
%   it more volatile..
