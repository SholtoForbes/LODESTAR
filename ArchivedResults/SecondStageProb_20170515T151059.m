...
dlmwrite('ThirdStage.txt',[ThirdStagePayloadMass;ThirdStageControls;ThirdStageZeta;ThirdStagePhi;ThirdStageAlt;ThirdStagev;ThirdStaget;ThirdStageAlpha;ThirdStagem;ThirdStagegamma;ThirdStageq]);
...
% Run First Stage =========================================================
[FirstStageStates] = FirstStageProblem(V(end),gamma(end));
