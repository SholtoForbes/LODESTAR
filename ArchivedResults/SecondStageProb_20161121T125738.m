...
global Constq_traj
Constq_traj = dlmread('primalConstq.txt');
...
[scattered.AoA,scattered.flapdeflection,scattered.drag,scattered.flap_pm] = LiftForceInterp(communicator,communicator_trim,const,Atmosphere,scattered.T,scattered.fuel, Constq_traj, scattered);
