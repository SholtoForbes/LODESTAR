...
[dfuel, Engine.Fueldt, a, q, M, Vehicle.Fd, Engine.Thrust, Vehicle.flapdeflection, Vehicle.Alpha, rho,Vehicle.lift,zeta,phi,Engine.eq,zetadot] = VehicleModel(time, gamma, V, v, mfuel, nodes,interp,gridded,const,gammadot, interp.Atmosphere,zeta,Stage2.mStruct,Stage3.mTot);

IspNet = (Engine.Thrust-Vehicle.Fd)./Engine.Fueldt./9.81;
