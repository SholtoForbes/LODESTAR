...
global ThirdStageData

interpn(ThirdStageData(:,1),ThirdStageData(:,2),ThirdStageData(:,3),ThirdStageData(:,4),ThirdStageData(:,5),ThirdStageData(:,6),phi(end),zeta(end),40000, theta(end), v(end))
