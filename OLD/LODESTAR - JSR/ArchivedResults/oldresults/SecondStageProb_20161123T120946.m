...
scattered.M1gridded = griddedInterpolant(MGrid,AOAGrid,M1_Grid,'spline','linear');
scattered.presgridded = griddedInterpolant(MGrid,AOAGrid,pres_Grid,'spline','linear');
scattered.tempgridded = griddedInterpolant(MGrid,AOAGrid,temp_Grid,'spline','linear');
...
scattered.IspGridded = griddedInterpolant(M1Grid,T1Grid,Isp_Grid,'spline','linear');
