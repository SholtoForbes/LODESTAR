...
i = 1;
[dr(i),dxi(i),dphi(i),dgamma(i),dv(i),dzeta(i)] = RotCoordsFirst(h(i)+rEarth,xi(i),phi(i),gamma(i),v(i),zeta(i),L(i),D(i),T(i),m(i),alpha(i),phase);

for i= 2:length(t)
xi(i) = xi(i-1) + dxi(i-1)*(t(i) - t(i-1));
[dr(i),dxi(i),dphi(i),dgamma(i),dv(i),dzeta(i)] = RotCoordsFirst(h(i)+rEarth,xi,phi(i),gamma(i),v(i),zeta(i),L(i),D(i),T(i),m(i),alpha(i),phase);
end
