...
scattered.MList = linspace(min(communicator(:,1)),max(communicator(:,1)),100);
scattered.AOAList = linspace(min(communicator(:,2)),max(communicator(:,2)),100);
scattered.M1_GridFit = gridfit(communicator(:,1),communicator(:,2),communicator(:,12),100,100);
scattered.pres_GridFit = gridfit(communicator(:,1),communicator(:,2),communicator(:,13),100,100);
scattered.temp_GridFit = gridfit(communicator(:,1),communicator(:,2),communicator(:,14),100,100);
...
scattered.Isp_GridFit = gridfit(data(:,1),data(:,2),data(:,6),100,100);
scattered.M1List = linspace(min(data(:,1)),max(data(:,1)),100);
scattered.TList = linspace(min(data(:,2)),max(data(:,2)),100);
