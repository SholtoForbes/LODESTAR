...
[dfuel, Fueldt, a, q, M, Fd, Thrust, flapdeflection, Alpha, rho,lift,zeta,phi,eq,zetadot] = VehicleModel(time, gamma, V, v, mfuel, nodes,interp,gridded,const,gammadot, Atmosphere, SPARTAN_SCALE,zeta,mstruct,mThirdStage);
