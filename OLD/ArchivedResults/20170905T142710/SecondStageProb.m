...
% Time Bounds
bounds.lower.time 	= [t0; Stage2.Bounds.time(1)];	
bounds.upper.time	= [t0; Stage2.Bounds.time(2)];
...
gammadot = primal.states(5,:)*scale.gammadot;

zeta = primal.states(6,:);

omegadot = primal.controls(1,:)*scale.gamma;
