...
[VGrid,thetaGrid,vGrid] = ndgrid(min(min(min(VGrid))):1000:max(max(max(VGrid))),[0 0.0125 0.025 0.0375 0.05],[min(min(min(vGrid))):25:max(max(max(vGrid)))]); % must match the data in thirdstage.dat
