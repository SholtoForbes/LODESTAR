...
[VGrid,thetaGrid,vGrid] = ndgrid(33000:1000:38000,[0 0.0125 0.025 0.0375 0.05],[2825:25:3000]); % must match the data in thirdstage.dat
...
mfuelL = 0;
% mfuelU = 994*SPARTAN_SCALE; % Dawids fuel mass
 mfuelU = 1562*SPARTAN_SCALE; % Sholtos fuel mass
