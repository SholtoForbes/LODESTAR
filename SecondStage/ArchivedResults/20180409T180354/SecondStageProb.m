...
bounds.phase.state.lower = [altMin3,vMin3, gammaMin3, 0, aoaMin, phiMin, zetaMin];
bounds.phase.state.upper = [altMax3, vMax3, gammaMax3, auxdata.ThirdStagem, aoaMax, phiMax, zetaMax];

bounds.phase.finalstate.lower = [altMin3, vMin3, 0, 0, 0, phiMin3, zetaMin3];
bounds.phase.finalstate.upper = [altMax3, vMax3, gammaMax3, auxdata.ThirdStagem, 0, phiMax, zetaMax];
