...
bounds.phase.initialtime.upper = 10000;
bounds.phase.finaltime.lower = 1;
bounds.phase.finaltime.upper = 10000;
...
bounds.phase(3).initialstate.lower = [altMin3,vMin3, gammaMin3,  auxdata.ThirdStagem, aoaMin3, phiMin3, zetaMin3];
bounds.phase(3).initialstate.upper = [altMax3, vMax3, gammaMax3, auxdata.ThirdStagem, aoaMax, phiMax3, zetaMax3];


bounds.phase(3).state.lower = [altMin3,vMin3, gammaMin3, 0, aoaMin3, phiMin3, zetaMin3];
bounds.phase(3).state.upper = [altMax3, vMax3, gammaMax3, auxdata.ThirdStagem, aoaMax, phiMax3, zetaMax3];
...
bounds.eventgroup(3).lower = [zeros(1,7) 90000];
bounds.eventgroup(3).lower = [zeros(1,7) 566000];

tGuess              = [0; 150];
altGuess            = [35000; 60000];
vGuess          = [2700; 6000];
gammaGuess            = [0; rad2deg(10)];
mGuess              = [3300; 2000];
