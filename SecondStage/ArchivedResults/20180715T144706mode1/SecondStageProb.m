...
aero1.aero_EngineOff = importdata('SPARTANaero15.1255');
aero1.flapaero = importdata('SPARTANaeroFlaps15.1255');
aero1.aero_EngineOn = importdata('SPARTANaeroEngineOn15.1255');
aero1.aero_Engine = importdata('SPARTANEngine15.1255');
...
aero2.aero_EngineOff = importdata('SPARTANaero15.1255');
aero2.flapaero = importdata('SPARTANaeroFlaps15.1255');
aero2.aero_EngineOn = importdata('SPARTANaeroEngineOn15.1255');
aero2.aero_Engine = importdata('SPARTANEngine15.1255');
...
bounds.phase.finalstate.lower = [20000, 2, -1, 2400, 0, Stage2.Bounds.zeta(1), aoaMin21, bankMin21, Stage2.End.mFuel];
...
bounds.phase.integral.lower = -1000000000000000000;
bounds.phase.integral.upper = 10000000000000000000;
%%  Guess =================================================================
