...
% End States
bounds.phase(1).finalstate.lower = [33000, lonMin, latMin, Stage2.Bounds.v(1), Stage2.End.gammaOpt(1), Stage2.End.Zeta, aoaMin, bankMin1, Stage2.End.mFuel];
...
guess.phase(1).state(:,1)   = [22000;34000];
