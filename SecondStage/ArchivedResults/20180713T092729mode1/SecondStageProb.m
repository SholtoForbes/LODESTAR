...
bounds.eventgroup(2).lower = [-1 -1]; % Constrain final latitude and longitude, with variable first stage approximation
bounds.eventgroup(2).upper = [1 1]; 
...
for i = 1: length(output.result.solution.phase(1).state(1,:))-1
...
for i = 1: length(output.result.solution.phase(2).state(1,:))-2
...
for i = [1:3 6: length(output.result.solution.phase(3).state(1,:))]
