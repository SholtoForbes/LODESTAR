...
elseif mode ==3 || mode == 32
        bounds.phase(2).path.lower = [30000];
    bounds.phase(2).path.upper = [60000];
end

bounds.phas2(2).integral.lower = -10000000000;
bounds.phas2(2).integral.upper = 10000000000;
%%  Guess =================================================================
...
% End State Bounds
bounds.phase(3).finalstate.lower = [altMin, lonMin, latMin2, speedMin, deg2rad(-20), aziMin, aoaMin21, bankMin21, Stage2.End.mFuel, throttleMin];
bounds.phase(3).finalstate.upper = [altMax, lonMax, latMax2, speedMax, deg2rad(30), aziMax, aoaMax21, bankMax21, Stage2.End.mFuel, throttleMax];
