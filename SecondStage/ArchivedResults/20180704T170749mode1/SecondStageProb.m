...
copyfile('SecondStageStates',sprintf('../ArchivedResults/%s/SecondStage_%s',strcTimestamp,'modat(e',num2str(mode)),Timestamp);
...
movefile('ThirdStage.png',sprintf('../ArchivedResults/%s',strcTimestamp,'modat(e',num2str(mode)));
