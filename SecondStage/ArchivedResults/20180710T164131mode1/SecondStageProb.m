...
bounds.phase(3).finalstate.lower = [altMin, lonMin, latMin, speedMin, deg2rad(-20), aziMin, aoaMin21, bankMin21, mFuelF, throttleMin];
bounds.phase(3).finalstate.upper = [altMax, lonMax, latMax, speedMax, deg2rad(30), aziMax, aoaMax21, bankMax21, mFuelF, throttleMax];
