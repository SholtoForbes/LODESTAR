...
bounds.phase(3).initialstate.lower = [altMin3,vMin3, gammaMin3,  auxdata.Stage3.mTot, aoaMin3, phiMin3, zetaMin3];
bounds.phase(3).initialstate.upper = [altMax3, vMax3, gammaMax3, auxdata.Stage3.mTot, aoaMax, phiMax3, zetaMax3];


bounds.phase(3).state.lower = [altMin3,vMin3, gammaMin3, 0, aoaMin3, phiMin3, zetaMin3];
bounds.phase(3).state.upper = [altMax3, vMax3, gammaMax3, auxdata.Stage3.mTot, aoaMax, phiMax3, zetaMax3];
...
bounds.eventgroup(3).upper = [zeros(1,6) 1000 566000];
