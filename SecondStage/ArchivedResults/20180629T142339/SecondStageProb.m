...
aero1.aero_EngineOff.fullFuel = importdata('SPARTANaero15.228');
aero1.flapaero.fullFuel = importdata('SPARTANaeroFlaps15.228');
aero1.aero_EngineOn.fullFuel = importdata('SPARTANaeroEngineOn15.228');
aero1.aero_EngineOn.fullFuel = importdata('SPARTANaeroEngine15.228');
...
aero2.aero_EngineOff.noFuel = importdata('SPARTANaero15.727');
aero2.flapaero.noFuel = importdata('SPARTANaeroFlaps15.727');
aero2.aero_EngineOn.noFuel = importdata('SPARTANaeroEngineOn15.727');
aero2.aero_EngineOn.noFuel = importdata('SPARTANaeroEngine15.727');
...
aero3.aero_EngineOff.noThirdStage = importdata('SPARTANaero15.1255');
aero3.flapaero.noThirdStage = importdata('SPARTANaeroFlaps15.1255');
aero3.aero_EngineOn.noThirdStage = importdata('SPARTANaeroEngineOn15.1255');
aero3.aero_EngineOn.noThirdStage = importdata('SPARTANaeroEngine15.1255');
...
output_temp = gpops2(setup_par(i));

% Calculate the result which gives the closest return forward sim ground track
% Return Forward
