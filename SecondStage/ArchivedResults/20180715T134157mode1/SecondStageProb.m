...
% Initial States
bounds.phase.initialstate.lower = [Stage2.Bounds.Alt(1),lon0, lat0, Stage2.Bounds.v(1), 0, deg2rad(90), aoaMin21, bankMin21, Stage2.Initial.mFuel] ;
bounds.phase.initialstate.upper = [Stage2.Bounds.Alt(2),lon0, lat0, Stage2.Bounds.v(2), deg2rad(15), deg2rad(90), aoaMax21, bankMax21, Stage2.Initial.mFuel];
...
bounds.phase.finalstate.lower = [20000, 2, -1, 2300, 0, Stage2.Bounds.zeta(1), aoaMin21, bankMin21, Stage2.End.mFuel];
...
% Control Bounds
bounds.phase.control.lower = [deg2rad(-.5), deg2rad(-1), 0];
bounds.phase.control.upper = [deg2rad(.5), deg2rad(1), 1];
...
guess.phase.control      = [[0;0],[0;0],[1;1]];
