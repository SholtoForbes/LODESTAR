...
bounds.phase.finalstate.lower = [20000, 2, -1, 2300, 0, Stage2.Bounds.zeta(1), aoaMin21, 0, Stage2.End.mFuel];
bounds.phase.finalstate.upper = [45000, 3, 1, Stage2.Bounds.v(2), deg2rad(20), Stage2.Bounds.zeta(2), aoaMax21, 0, Stage2.End.mFuel];
