...
[VGrid,gammaGrid,vGrid] = ndgrid(unique(ThirdStageData(:,3)),deg2rad([3:0.5:6.5]),unique(ThirdStageData(:,5))); % must match the data in thirdstage.dat. Gamma truncated at 7 deg because third stage gets bad after this
