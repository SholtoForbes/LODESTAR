...
lonf = deg2rad(145); % !!! CHANGE THIS TO TAKE FIRST STAGE INTO ACCOUNT
latf   = -0.269;
...
guess.phase(2).state   = [altGuess, lonGuess, latGuess, speedGuess, fpaGuess, aziGuess, aoaGuess, bankGuess, mFuelGuess,[0.2;0]];
