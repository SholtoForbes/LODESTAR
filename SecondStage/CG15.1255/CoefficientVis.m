...
aero_EngineOff = importdata('SPARTANaero15.228');

aero_EngineOn = importdata('SPARTANaeroEngineOn15.228');

flapaero = importdata('SPARTANaeroFlaps15.228');


aero_EngineOff3 = importdata('SPARTANaero15.1255');

aero_EngineOn3 = importdata('SPARTANaeroEngineOn15.1255');

flapaero3 = importdata('SPARTANaeroFlaps15.1255');


aero_EngineOff2 = importdata('SPARTANaero15.727');

aero_EngineOn2 = importdata('SPARTANaeroEngineOn15.727');

flapaero2 = importdata('SPARTANaeroFlaps15.727');
