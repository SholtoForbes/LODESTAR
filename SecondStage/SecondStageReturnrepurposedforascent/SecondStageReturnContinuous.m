...
[raddot,londot,latdot,fpadot,vdot,azidot, q, M, Fd, rho,L,Fueldt,T] = VehicleModelReturn(fpa, rad, v,auxdata,azi,lat,lon,aoa,0,1, mFuel);
...
phaseout.dynamics  = [raddot, londot, latdot, vdot, fpadot, azidot, aoadot, -Fueldt];
