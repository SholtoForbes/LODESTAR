...
if plotaero == 'yes'
figure(401)
contourf(MList,AOAList,Cl_Grid_noflap,5000,'LineWidth',0.)
xlabel('Mach no.')
ylabel('Angle of Attack (deg)')
c = colorbar;
...
figure(402)
contourf(MList,AOAList,Cd_Grid_noflap,5000,'LineWidth',0.)
xlabel('Mach no.')
ylabel('Angle of Attack (deg)')
c = colorbar;
...
figure(403)
contourf(MList,AOAList,Cl_Grid_noflap./Cd_Grid_noflap,5000,'LineWidth',0.)
xlabel('Mach no.')
ylabel('Angle of Attack (deg)')
c = colorbar;
c.Label.String = 'L/D';
