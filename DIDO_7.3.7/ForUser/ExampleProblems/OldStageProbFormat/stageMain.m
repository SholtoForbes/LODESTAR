...
stageProb.dynamics  = 'stageDynamics2001';  %%% *****  NOTE  ******
...
knots.locations    = [t0  t1Guess tfGuess];
knots.definitions  = {'hard','hard','hard'};
knots.bounds.lower = [0 eps .06];           
knots.bounds.upper = [0 tfMax/2 tfMax];
knots.numNodes     = [10 30];
