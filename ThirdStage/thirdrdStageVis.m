...
[VGrid,thetaGrid,vGrid] = ndgrid(33000:500:35000,[deg2rad(1.5) :deg2rad(.5): deg2rad(3.5)],[2850:25:2925]);
...
colormap(gray)
C = contourf(rad2deg(thetaGrid(:,:,2)),VGrid(:,:,2)/1000,PayloadData(:,:,2),20,'LineWidth',0.)
